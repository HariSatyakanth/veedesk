...
class _AssignedTasksState extends State<AssignedTasks> {
  int _activeElevationId = -1,
      _KIVElevationId = -1,
      _CompletedElevationId = -1,
      _progressElevationId = -1,
      _holdElevationId = -1;
  DateTime now;
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          dateToday,
                          style: Constants()
                              .txtStyleFont16(Colors.grey[600], 14.0),
                        ),
                        SizedBox(
                          height: 20.0,
                        ),
  ...
  _searchBar() {
    return TextField(
      ...
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => SearchPage(0)));
      },
...
//                  _timeDifference = now.difference(_taskAssignTime).toString();
                              return Row(
                                children: [
                                  SizedBox(
                                    height:
                                        _activeElevationId == i ? 270.0 : 250.0,
                                    width: Constants().containerWidth(context) *
                                        0.65,
                                    child: InkWell(
                                      onTap: () {
                                        print(_timeDifference);
                                        setState(() {
                                      ...
                                      child: Card(
                                        elevation: _activeElevationId == i
                                            ? 30.0
                                            : 0.0,
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Text(activeTaskList[i].progress+"%",
                                                          style: Constants()
                                                              .txtStyleFont16(
                                                                  Colors.black,
                                                                  12.0)),
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Card(
                                        elevation: _progressElevationId == i
                                            ? 30.0
                                            : 0.0,
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Text(progressTaskList[i].progress+"%",
                                                          style: Constants()
                                                              .txtStyleFont16(
                                                                  Colors.black,
                                                                  12.0)),
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child:
                                                            LinearProgressIndicator(
                                                          value:  double.parse(progressTaskList[i].progress)/100,
                                                        ),
                                                      )
                                                    ],
                                                  )
                            ...
                            itemBuilder: (context, i) {
                              return Row(
                                children: [
                                  SizedBox(
                                    height:
                                        _holdElevationId == i ? 270.0 : 250.0,
                                    width: Constants().containerWidth(context) *
                                        0.65,
                                    child: InkWell(
                                      onTap: () {
                                      ...
                                      child: Card(
                                        elevation:
                                            _holdElevationId == i ? 30.0 : 0.0,
                                        shadowColor: Color(0xFFFFD600),
                                        shape: RoundedRectangleBorder(
                                            borderRadius:
                                                BorderRadius.circular(25.0)),
                                        child: Row(
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child:
                                                            LinearProgressIndicator(
                                                          value:  double.parse(holdTaskList[i].progress)/100,
                                                        ),
                                                      )
                                                    ],
                                                  )
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child:
                                                            LinearProgressIndicator(
                                                          value:  double.parse(KIVTaskList[i].progress)/100,
                                                        ),
                                                      )
                                                    ],
                                                  )
...
//                  _timeDifference = now.difference(_taskAssignTime).toString();
                              return Row(
                                children: [
                                  SizedBox(
                                    height: _CompletedElevationId == i
                                        ? 270.0
                                        : 250.0,
                                    width: Constants().containerWidth(context) *
                                        0.65,
                                    child: InkWell(
                                      ...
                                      child: Card(
                                        elevation: _CompletedElevationId == i
                                            ? 30.0
                                            : 0.0,
                                        shadowColor: Colors.blue,
                                        shape: RoundedRectangleBorder(
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Text(completedTaskList[i].progress+"%",
                                                          style: Constants()
                                                              .txtStyleFont16(
                                                                  Colors.black,
                                                                  12.0)),
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child:
                                                            LinearProgressIndicator(
                                                          value:  double.parse(completedTaskList[i].progress)/100,
...
//get Task lists
  ...
  Future<dynamic> _getActiveTaskLists() async {
    ...
    try {
      await http
          .get(
              "${Constants.BaseUrl}action=taskAssignedById&assignedById=${Constants.userId}")
          .then((res) {
        print(res.body);
        ...
        /*      if (status == "Assigned") {
              ...
              if (status == "Ongoing" || status=="Assigned") {
                setState(() {
